...
function renderEmotionsSection(): void {
    ...
    emotionsData.forEach(item => {
        ...
        eventListeners.push({ element: emotionCard, type: 'click', listener: clickListener });
        ...
        eventListeners.push({ element: emotionCard, type: 'keydown', listener: keydownListener });
