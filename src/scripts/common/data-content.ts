...
export const shapesData: IShapeData[] = [
  {
    name: "Circle",
    svgPath:
      '<svg width="80" height="80" viewBox="0 0 80 80"><circle cx="40" cy="40" r="35" fill="#FF9E80" /></svg>',
  },
  {
    name: "Square",
    svgPath:
      '<svg width="80" height="80" viewBox="0 0 80 80"><rect x="10" y="10" width="60" height="60" fill="#64B5F6" /></svg>',
  },
  {
    name: "Triangle",
    svgPath:
      '<svg width="80" height="80" viewBox="0 0 80 80"><polygon points="40,10 10,70 70,70" fill="#FFEB3B" /></svg>',
  },
  {
    name: "Rectangle",
    svgPath:
      '<svg width="80" height="80" viewBox="0 0 80 80"><rect x="10" y="20" width="60" height="40" fill="#81C784" /></svg>',
  },
  {
    name: "Oval",
    svgPath:
      '<svg width="80" height="80" viewBox="0 0 80 80"><ellipse cx="40" cy="40" rx="35" ry="25" fill="#E57373" /></svg>',
  },
  {
    name: "Diamond",
    svgPath:
      '<svg width="80" height="80" viewBox="0 0 80 80"><polygon points="40,10 70,40 40,70 10,40" fill="#9575CD" /></svg>',
  },
  {
    name: "Star",
    svgPath:
      '<svg width="80" height="80" viewBox="0 0 80 80"><polygon points="40,10 48,30 70,30 52,45 60,65 40,52 20,65 28,45 10,30 32,30" fill="#FFD54F" /></svg>',
  },
  {
    name: "Heart",
    svgPath:
      '<svg width="80" height="80" viewBox="0 0 80 80"><path d="M40,70 C40,70 10,50 10,30 C10,20 20,10 30,10 C35,10 40,15 40,15 C40,15 45,10 50,10 C60,10 70,20 70,30 C70,50 40,70 40,70 Z" fill="#F06292" /></svg>',
  },
  {
    name: "Cross",
    svgPath:
      '<svg width="80" height="80" viewBox="0 0 80 80"><rect x="30" y="10" width="20" height="60" fill="#9C27B0" /><rect x="10" y="30" width="60" height="20" fill="#9C27B0" /></svg>',
  },
];
